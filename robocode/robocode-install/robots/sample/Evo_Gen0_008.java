 ...
 */
public class Evo_Gen0_008 extends AdvancedRobot {

    // === PARAMETERS (injected during generation) ===
        private static final double PARAM_PREFERRED_DISTANCE = 190.8929;
    private static final double PARAM_MOVE_DISTANCE = 170.1025;
    private static final double PARAM_DIRECTION_CHANGE_RATE = 0.0604;
    private static final double PARAM_DIRECTION_CHANGE_INTERVAL = 22.6079;
    private static final double PARAM_RANDOM_CHANGE_RATE = 0.0158;
    private static final double PARAM_MAX_TURN_ANGLE = 64.7616;
    private static final double PARAM_FIRE_POWER_CLOSE = 2.6768;
    private static final double PARAM_FIRE_POWER_MEDIUM = 1.9292;
    private static final double PARAM_FIRE_POWER_FAR = 0.7914;
    private static final double PARAM_RADAR_LOCK_EXTRA = 7.7008;
