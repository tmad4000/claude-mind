 ...
 */
public class Evo_Gen1_005 extends AdvancedRobot {

    // === PARAMETERS (injected during generation) ===
        private static final double PARAM_PREFERRED_DISTANCE = 379.5182;
    private static final double PARAM_MOVE_DISTANCE = 163.3522;
    private static final double PARAM_DIRECTION_CHANGE_RATE = 0.0404;
