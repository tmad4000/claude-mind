 ...
 */
public class Evo_Gen1_004 extends AdvancedRobot {

    // === PARAMETERS (injected during generation) ===
        private static final double PARAM_PREFERRED_DISTANCE = 349.9764;
    private static final double PARAM_MOVE_DISTANCE = 116.6271;
    private static final double PARAM_DIRECTION_CHANGE_RATE = 0.0620;
    private static final double PARAM_DIRECTION_CHANGE_INTERVAL = 28.4551;
    private static final double PARAM_RANDOM_CHANGE_RATE = 0.0239;
    private static final double PARAM_MAX_TURN_ANGLE = 44.3726;
    private static final double PARAM_FIRE_POWER_CLOSE = 2.9778;
    private static final double PARAM_FIRE_POWER_MEDIUM = 1.6921;
    private static final double PARAM_FIRE_POWER_FAR = 1.1534;
    private static final double PARAM_RADAR_LOCK_EXTRA = 15.7021;
