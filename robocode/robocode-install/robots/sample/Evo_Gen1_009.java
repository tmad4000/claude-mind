 ...
 */
public class Evo_Gen1_009 extends AdvancedRobot {

    // === PARAMETERS (injected during generation) ===
        private static final double PARAM_PREFERRED_DISTANCE = 188.4316;
    private static final double PARAM_MOVE_DISTANCE = 161.0145;
    private static final double PARAM_DIRECTION_CHANGE_RATE = 0.0701;
    private static final double PARAM_DIRECTION_CHANGE_INTERVAL = 19.8955;
    ...
    private static final double PARAM_RADAR_LOCK_EXTRA = 5.1653;
