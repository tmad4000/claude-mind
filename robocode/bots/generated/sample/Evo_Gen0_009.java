 ...
 */
public class Evo_Gen0_009 extends AdvancedRobot {

    // === PARAMETERS (injected during generation) ===
        private static final double PARAM_PREFERRED_DISTANCE = 374.4948;
    private static final double PARAM_MOVE_DISTANCE = 198.9010;
    private static final double PARAM_DIRECTION_CHANGE_RATE = 0.0338;
    private static final double PARAM_DIRECTION_CHANGE_INTERVAL = 15.6320;
    private static final double PARAM_RANDOM_CHANGE_RATE = 0.0437;
    private static final double PARAM_MAX_TURN_ANGLE = 33.8002;
    private static final double PARAM_FIRE_POWER_CLOSE = 2.6905;
    private static final double PARAM_FIRE_POWER_MEDIUM = 1.9528;
    private static final double PARAM_FIRE_POWER_FAR = 1.0563;
    private static final double PARAM_RADAR_LOCK_EXTRA = 18.2886;
