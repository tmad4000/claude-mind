 ...
 */
public class Evo_Gen1_008 extends AdvancedRobot {

    // === PARAMETERS (injected during generation) ===
        private static final double PARAM_PREFERRED_DISTANCE = 199.2270;
    private static final double PARAM_MOVE_DISTANCE = 181.5413;
    private static final double PARAM_DIRECTION_CHANGE_RATE = 0.0421;
    private static final double PARAM_DIRECTION_CHANGE_INTERVAL = 23.3758;
    private static final double PARAM_RANDOM_CHANGE_RATE = 0.0301;
    private static final double PARAM_MAX_TURN_ANGLE = 57.3539;
    private static final double PARAM_FIRE_POWER_CLOSE = 2.6592;
    private static final double PARAM_FIRE_POWER_MEDIUM = 1.8415;
    private static final double PARAM_FIRE_POWER_FAR = 1.1670;
    private static final double PARAM_RADAR_LOCK_EXTRA = 13.2572;
