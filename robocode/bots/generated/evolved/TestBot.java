...
public class TestBot extends AdvancedRobot {
    ...
    // === PARAMETERS (injected during generation) ===
        private static final double PARAM_PREFERRED_DISTANCE = 350.6246;
    private static final double PARAM_MOVE_DISTANCE = 103.1803;
    private static final double PARAM_DIRECTION_CHANGE_RATE = 0.0899;
    private static final double PARAM_DIRECTION_CHANGE_INTERVAL = 28.7288;
    private static final double PARAM_RANDOM_CHANGE_RATE = 0.0333;
    private static final double PARAM_MAX_TURN_ANGLE = 44.7630;
    private static final double PARAM_FIRE_POWER_CLOSE = 2.5501;
    private static final double PARAM_FIRE_POWER_MEDIUM = 2.1799;
    private static final double PARAM_FIRE_POWER_FAR = 1.0364;
    private static final double PARAM_RADAR_LOCK_EXTRA = 13.6492;
